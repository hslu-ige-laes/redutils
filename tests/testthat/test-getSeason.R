...
test_that("getSeason", {
  ...
  expect_match(getSeason(as.Date("2019-12-31"), seasonNames = c("Winter","Frühling","Sommer","Herbst")),"Winter")
  expect_match(getSeason(as.Date("2019-03-01"), seasonNames = c("Winter","Frühling","Sommer","Herbst")),"Frühling")
  expect_match(getSeason(as.Date("2019-06-01"), seasonNames = c("Winter","Frühling","Sommer","Herbst")),"Sommer")
  expect_match(getSeason(as.Date("2019-09-01"), seasonNames = c("Winter","Frühling","Sommer","Herbst")),"Herbst")
})
